  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "ایمیل",
      value: "hello@virgool.ir",
      description: "برای پیام‌های عمومی و سوالات",
      color: "blue",
      href: "mailto:hello@virgool.ir"
    },
    {
      icon: Phone,
      title: "تلفن",
    ...
    },
    {
      icon: MapPin,
      title: "آدرس",
      value: "شهرقدس، دبیرستان علامه حلی",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-6 text-white">
                ...
                <a 
                  href="mailto:partners@virgool.ir"
              ...
              <div className="bg-white/80 backdrop-blur-lg border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    className={`w-full bg-gradient-to-r from-blue-400 to-blue-600 text-white font-bold py-4 rounded-xl transition-all duration-300 hover:shadow-lg ${
                  ...
                  <p className="text-center text-gray-500 text-sm">
                    یا مستقیماً به{" "}
                    <a href="mailto:hello@virgool.ir" className="text-blue-500 hover:text-blue-600 font-medium">
                      hello@virgool.ir
                    </a>{" "}
                    ایمیل بزنید
                  </p>
